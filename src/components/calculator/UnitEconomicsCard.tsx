  ...
  return (
    <div className="bg-[#18181b] border border-[#27272a] rounded-2xl p-5 sm:p-6 shadow-sm space-y-5">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div className="sm:col-span-2">
          ...
          <div className="relative">
            <input
              ...
              placeholder="e.g. Luxury Silk Bomber Jacket"
            />
          </div>
        </div>
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full bg-[#09090b] border border-[#27272a] focus:border-emerald-500 rounded-xl pl-9 pr-3.5 py-2 text-xs font-bold font-mono-nums text-[#f4f4f5] outline-none transition"
              placeholder="0.00"
            />
          </div>
        </div>
        ...
        <div>
          <label className="block text-xs font-medium text-[#a1a1aa] mb-1.5">
            Number of Units (Batch / Stock)
          </label>
          <div className="relative">
            <Boxes className="w-3.5 h-3.5 text-[#71717a] absolute left-3.5 top-1/2 -translate-y-1/2" />
            <input
              type="number"
              min="1"
              step="1"
              ...
              className="w-full bg-[#09090b] border border-[#27272a] focus:border-emerald-500 rounded-xl pl-9 pr-3.5 py-2 text-xs font-semibold font-mono-nums text-[#f4f4f5] outline-none transition"
              placeholder="500"
            />
          </div>
        </div>
        ...
        <div>
          ...
          <div className="relative">
            <Truck className="w-3.5 h-3.5 text-[#71717a] absolute left-3.5 top-1/2 -translate-y-1/2" />
            <input
              type="number"
              step="any"
              min="0"
      ...
      <div className="pt-3 border-t border-[#27272a]/60">
        <div className="flex items-center justify-between mb-2">
          ...
          <div className="flex items-center gap-1">
            <input
              ...
              className={`w-14 bg-[#09090b] border border-[#27272a] rounded-lg px-2 py-0.5 text-xs font-bold font-mono-nums text-right outline-none ${getFulfillmentColor(
        ...
        <div className="flex items-center justify-between text-[11px] text-[#71717a] mt-1">
          <span>50% (High return risk)</span>
          <span className="font-mono-nums">
            {Math.round(activeProductMetrics.adjustedDeliveredUnits)} of{' '}
            {activeProduct.units.toLocaleString()} units delivered
          </span>
          <span>100% (Zero returns)</span>
        </div>
      </div>
    </div>
  );
