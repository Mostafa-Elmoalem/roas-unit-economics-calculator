    ...
    <div className="bg-white dark:bg-[#18181b] border border-zinc-200 dark:border-[#27272a] rounded-2xl p-5 sm:p-6 shadow-xs space-y-5 transition-colors duration-200">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div className="sm:col-span-2">
          <label className="block text-xs font-medium text-zinc-600 dark:text-[#a1a1aa] mb-1.5">
          ...
          <div className="relative">
            <input
              ...
              className="w-full bg-zinc-50 dark:bg-[#09090b] border border-zinc-200 dark:border-[#27272a] focus:border-emerald-500 rounded-xl px-3.5 py-2 text-xs font-medium text-zinc-900 dark:text-[#f4f4f5] outline-none transition"
        ...
        <div>
          ...
          <div className="relative">
            <span className="absolute left-3.5 rtl:right-3.5 rtl:left-auto top-1/2 -translate-y-1/2 text-xs font-semibold text-zinc-400 dark:text-[#71717a]">
              {currency === 'EGP' ? 'EGP' : '$'}
            </span>
            <input
              type="number"
              ...
              className="w-full bg-zinc-50 dark:bg-[#09090b] border border-zinc-200 dark:border-[#27272a] focus:border-emerald-500 rounded-xl pl-9 rtl:pr-9 rtl:pl-3.5 pr-3.5 py-2 text-xs font-bold font-mono-nums text-zinc-900 dark:text-[#f4f4f5] outline-none transition"
              placeholder="0.00"
            />
          </div>
        </div>
        ...
        <div>
          ...
          <div className="relative">
            <Boxes className="w-3.5 h-3.5 text-zinc-400 dark:text-[#71717a] absolute left-3.5 rtl:right-3.5 rtl:left-auto top-1/2 -translate-y-1/2" />
            <input
              type="number"
              min="1"
              step="1"
              ...
              className="w-full bg-zinc-50 dark:bg-[#09090b] border border-zinc-200 dark:border-[#27272a] focus:border-emerald-500 rounded-xl pl-9 rtl:pr-9 rtl:pl-3.5 pr-3.5 py-2 text-xs font-semibold font-mono-nums text-zinc-900 dark:text-[#f4f4f5] outline-none transition"
              placeholder="500"
            />
          </div>
        </div>
        ...
        <div>
          ...
          <div className="relative">
            <Truck className="w-3.5 h-3.5 text-zinc-400 dark:text-[#71717a] absolute left-3.5 rtl:right-3.5 rtl:left-auto top-1/2 -translate-y-1/2" />
            <input
              type="number"
              step="any"
              min="0"
      ...
      <div className="pt-3 border-t border-zinc-200 dark:border-[#27272a]/60">
        <div className="flex items-center justify-between mb-2">
          <div className="flex items-center gap-1.5">
            <Percent className="w-3.5 h-3.5 text-zinc-500 dark:text-[#a1a1aa]" />
            <label className="text-xs font-medium text-zinc-900 dark:text-[#f4f4f5]">
          ...
          <div className="flex items-center gap-1">
            <input
              ...
              className={`w-14 bg-zinc-50 dark:bg-[#09090b] border border-zinc-200 dark:border-[#27272a] rounded-lg px-2 py-0.5 text-xs font-bold font-mono-nums text-right rtl:text-left outline-none ${getFulfillmentColor(
                activeProduct.fulfillmentRate ?? 80
              )}`}
            />
            <span className="text-xs text-zinc-400 dark:text-[#71717a]">%</span>
          </div>
        </div>
        ...
        <div className="flex items-center justify-between text-[11px] text-zinc-400 dark:text-[#71717a] mt-1">
          <span>{t('calculator.highReturnRisk')}</span>
          <span className="font-mono-nums font-medium text-zinc-600 dark:text-zinc-400">
